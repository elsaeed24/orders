        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-right">
                        <form action="" method="get">
                            <a class="list-group-item list-group-item-action"  href="{{ route('show_order') }}">اظهار الطلبات السابقة</a>
                        ...
                        <div class="row">
                            ...
                            @forelse ($meals as $meal )
                                <div class="col-md-4 mt-2 text-center" style="border: 1px solid rgb(149, 212, 159) ;">
                                    <img src="{{ asset($meal->photo) }}" class="img-thumbnail" style="width:100%;">
                                    <strong>{{ $meal->name }}</strong>
                                    <p>{{ $meal->description }}</p>
                                    <div>

                                        <a href="{{ route('meal_detailes',$meal->id) }}" class="btn btn-success" style="font-size:16px" title="Add Cart">
