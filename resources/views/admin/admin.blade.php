            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header">
                        <a style="float:right;" href="{{ route('cat_show') }}"><button class="bnt btn-success btn-default"
                                style="margin-left:6px ;">إضافة صنف جديد </button></a>

                        <a style="float:right;" href="{{ route('meal_show') }}"><button class="bnt btn-danger btn-default"
                                style="margin-left:6px ;">إضافة وجبة </button></a>
                        <a style="float:right;" href="{{ route('meal_index') }}"><button class="bnt btn-info btn-default"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('changeStatus', $row->id) }}" method="post">
                                        @csrf
